                                ...
                                <div class="p-5">
                                    ...
                                    <form action="/usuario" method="post" class="user">
                                        <div class="form-group">
                                        	<input class="form-control form-control-user" type="email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Entre com o endereço de Email..." name="email">
                                        </div>
                                        <div class="form-group">
